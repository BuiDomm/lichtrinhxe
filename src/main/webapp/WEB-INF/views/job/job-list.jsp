...
<!-- Mirrored from shreethemes.net/jobstock-landing-2.2/jobstock/full-job-list-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 26 Sep 2024 02:52:16 GMT -->
<head>
    <meta charset="utf-8">
...
<div id="main-wrapper">
    ...
    <!-- ============================ Page Title Start================================== -->
    <%@include file="../modal/fillter-modal-job.jsp" %>
                                    ...
                                    <div class="jbs-list-caption">
                                        <div class="jbs-info-ico-style">
                                            ...
                                            <div class="jbs-single-y1 style-1">
                                                <span><i class="fa-solid fa-location-dot"></i></span>${job.location}
                                            </div>
                                            <!-- Hiển thị loại công việc (Full Time, Part Time, ...) -->
                                            <div class="jbs-single-y1 style-2">
                                                <span><i class="fa-solid fa-clock"></i></span>${job.workType}
                                            </div>
                                            <!-- Hiển thị số năm kinh nghiệm yêu cầu -->
                                            <div class="jbs-single-y1 style-3">
                                                <span><i class="fa-solid fa-coins"></i></span>${job.experienceRequired} Years exp.
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="jbs-list-caption">
                                    <div class="jbs-info-ico-style">
                                        <div class="jbs-single-y1 style-1"><span><i
                                                class="fa-solid fa-location-dot"></i></span>Canada, USA
                                        </div>
                                        <div class="jbs-single-y1 style-2"><span><i
                                                class="fa-solid fa-clock"></i></span>Part Time
                                        </div>
                                        <div class="jbs-single-y1 style-3"><span><i
                                                class="fa-solid fa-coins"></i></span>7 Years exp.
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-12">
                            <div class="jbs-list-box border">
                                <div class="jbs-list-head">
                                    <div class="jbs-list-head-thunner">
                                        <div class="jbs-list-emp-thumb jbs-verified"><a href="job-detail.html">
                                            <figure><img src="../../assets/img/l-3.png" class="img-fluid" alt="">
                                            </figure>
                                        </a></div>
                                        <div class="jbs-list-job-caption">
                                            <div class="jbs-job-employer-wrap"><span>Shopify</span></div>
                                            <div class="jbs-job-title-wrap"><h4><a href="job-detail.html"
                                                                                   class="jbs-job-title">Sr. Magento
                                                Developer</a></h4></div>
                                        </div>
                                    </div>
                                    <div class="jbs-list-head-last">
                                ...
                                <div class="jbs-list-caption">
                                    <div class="jbs-info-ico-style">
                                        <div class="jbs-single-y1 style-1"><span><i
                                                class="fa-solid fa-location-dot"></i></span>London, UK
                                        </div>
                                        <div class="jbs-single-y1 style-2"><span><i
                                                class="fa-solid fa-clock"></i></span>Enternship
                                        </div>
                                        <div class="jbs-single-y1 style-3"><span><i
                                                class="fa-solid fa-coins"></i></span>2 Years exp.
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-12">
                            <div class="jbs-list-box border">
                                <div class="jbs-list-head">
                                    <div class="jbs-list-head-thunner">
                                        <div class="jbs-list-emp-thumb jbs-verified"><a href="job-detail.html">
                                            <figure><img src="../../assets/img/l-4.png" class="img-fluid" alt="">
                                            </figure>
                                        </a></div>
                                        <div class="jbs-list-job-caption">
                                            <div class="jbs-job-employer-wrap"><span>Dreezoo</span></div>
                                            <div class="jbs-job-title-wrap"><h4><a href="job-detail.html"
                                                                                   class="jbs-job-title">Sr. Code
                                                Ignetor Developer</a></h4></div>
                                        </div>
                                    </div>
                                    <div class="jbs-list-head-last">
                                        <a href="JavaScript:Void(0);" class="btn btn-md btn-primary px-4">Quick
                                ...
                                <div class="jbs-list-caption">
                                    <div class="jbs-info-ico-style">
                                        <div class="jbs-single-y1 style-1"><span><i
                                                class="fa-solid fa-location-dot"></i></span>New York
                                        </div>
                                        <div class="jbs-single-y1 style-2"><span><i
                                                class="fa-solid fa-clock"></i></span>Part Time
                                        </div>
                                        <div class="jbs-single-y1 style-3"><span><i
                                                class="fa-solid fa-coins"></i></span>4 Years exp.
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-12">
                            <div class="jbs-list-box border">
                                <div class="jbs-list-head">
                                    <div class="jbs-list-head-thunner">
                                        <div class="jbs-list-emp-thumb jbs-verified"><a href="job-detail.html">
                                            <figure><img src="../../assets/img/l-5.png" class="img-fluid" alt="">
                                            </figure>
                                        </a></div>
                                        <div class="jbs-list-job-caption">
                                            <div class="jbs-job-employer-wrap"><span>Photoshop</span></div>
                                            <div class="jbs-job-title-wrap"><h4><a href="job-detail.html"
                                                                                   class="jbs-job-title">Java & Python
                                                Developer</a></h4></div>
                                        </div>
                                    </div>
                                    <div class="jbs-list-head-last">
                                ...
                                <div class="jbs-list-caption">
                                    <div class="jbs-info-ico-style">
                                        <div class="jbs-single-y1 style-1"><span><i
                                                class="fa-solid fa-location-dot"></i></span>California
                                        </div>
                                        <div class="jbs-single-y1 style-2"><span><i
                                                class="fa-solid fa-clock"></i></span>Contract
                                        </div>
                                        <div class="jbs-single-y1 style-3"><span><i
                                                class="fa-solid fa-coins"></i></span>3 Years exp.
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-12">
                            <div class="jbs-list-box border">
                                <div class="jbs-list-head">
                                    <div class="jbs-list-head-thunner">
                                        <div class="jbs-list-emp-thumb jbs-verified"><a href="job-detail.html">
                                            <figure><img src="../../assets/img/l-6.png" class="img-fluid" alt="">
                                            </figure>
                                        </a></div>
                                        <div class="jbs-list-job-caption">
                                            <div class="jbs-job-employer-wrap"><span>Firefox</span></div>
                                            <div class="jbs-job-title-wrap"><h4><a href="job-detail.html"
                                                                                   class="jbs-job-title">Sr. UI/UX
                                                Designer</a></h4></div>
                                        </div>
                                    </div>
                                    <div class="jbs-list-head-last">
                                ...
                                <div class="jbs-list-caption">
                                    <div class="jbs-info-ico-style">
                                        ...
                                        <div class="jbs-single-y1 style-2"><span><i
                                                class="fa-solid fa-clock"></i></span>Full Time
                                        </div>
                                        <div class="jbs-single-y1 style-3"><span><i
                                                class="fa-solid fa-coins"></i></span>6 Years exp.
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-12">
                            <div class="jbs-list-box border">
                                <div class="jbs-list-head">
                                    <div class="jbs-list-head-thunner">
                                        <div class="jbs-list-emp-thumb jbs-verified"><a href="job-detail.html">
                                            <figure><img src="../../assets/img/l-7.png" class="img-fluid" alt="">
                                            </figure>
                                        </a></div>
                                        <div class="jbs-list-job-caption">
                                            <div class="jbs-job-employer-wrap"><span>Airbnb</span></div>
                                            <div class="jbs-job-title-wrap"><h4><a href="job-detail.html"
                                                                                   class="jbs-job-title">Jr. Laravel
                                                Developer</a></h4></div>
                                        </div>
                                    </div>
                                    <div class="jbs-list-head-last">
                                ...
                                <div class="jbs-list-caption">
                                    <div class="jbs-info-ico-style">
                                        <div class="jbs-single-y1 style-1"><span><i
                                                class="fa-solid fa-location-dot"></i></span>London
                                        </div>
                                        <div class="jbs-single-y1 style-2"><span><i
                                                class="fa-solid fa-clock"></i></span>Part Time
                                        </div>
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-12">
                            <div class="jbs-list-box border">
                                <div class="jbs-list-head">
                                    <div class="jbs-list-head-thunner">
                                        <div class="jbs-list-emp-thumb jbs-verified"><a href="job-detail.html">
                                            <figure><img src="../../assets/img/l-8.png" class="img-fluid" alt="">
                                            </figure>
                                        </a></div>
                                        <div class="jbs-list-job-caption">
                                            <div class="jbs-job-employer-wrap"><span>Snapchat</span></div>
                                            <div class="jbs-job-title-wrap"><h4><a href="job-detail.html"
                                                                                   class="jbs-job-title">Sr. WordPress
                                                Developer</a></h4></div>
                                        </div>
                                    </div>
                                    <div class="jbs-list-head-last">
                                ...
                                <div class="jbs-list-caption">
                                    <div class="jbs-info-ico-style">
                                        <div class="jbs-single-y1 style-1"><span><i
                                                class="fa-solid fa-location-dot"></i></span>New York, USA
                                        </div>
                                        <div class="jbs-single-y1 style-2"><span><i
                                                class="fa-solid fa-clock"></i></span>Full Time
                                        </div>
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-12">
                            <div class="jbs-list-box border">
                                <div class="jbs-list-head">
                                    <div class="jbs-list-head-thunner">
                                        <div class="jbs-list-emp-thumb jbs-verified"><a href="job-detail.html">
                                            <figure><img src="../../assets/img/l-9.png" class="img-fluid" alt="">
                                            </figure>
                                        </a></div>
                                        <div class="jbs-list-job-caption">
                                            <div class="jbs-job-employer-wrap"><span>Dribbble</span></div>
                                            <div class="jbs-job-title-wrap"><h4><a href="job-detail.html"
                                                                                   class="jbs-job-title">Exp. Project
                                                manager</a></h4></div>
                                        </div>
                                    </div>
                                    <div class="jbs-list-head-last">
                                ...
                                <div class="jbs-list-caption">
                                    <div class="jbs-info-ico-style">
                                        ...
                                        <div class="jbs-single-y1 style-3"><span><i
                                                class="fa-solid fa-coins"></i></span>1 Years exp.
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-6 col-lg-12 col-md-12">
                            <div class="jbs-list-box border">
                                <div class="jbs-list-head">
                                    <div class="jbs-list-head-thunner">
                                        <div class="jbs-list-emp-thumb jbs-verified"><a href="job-detail.html">
                                            <figure><img src="../../assets/img/l-10.png" class="img-fluid" alt="">
                                            </figure>
                                        </a></div>
                                        <div class="jbs-list-job-caption">
                                            <div class="jbs-job-employer-wrap"><span>Skype</span></div>
                                            <div class="jbs-job-title-wrap"><h4><a href="job-detail.html"
                                                                                   class="jbs-job-title">Jr. PHP
                                                Developer</a></h4></div>
                                        </div>
                                    </div>
                                    <div class="jbs-list-head-last">
